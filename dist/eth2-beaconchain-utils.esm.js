...
function DeriveValidator(masterSecretKey, validatorIndex) {
  var secretKey = SecretKey.fromBytes(deriveEth2ValidatorKeys(masterSecretKey, validatorIndex).signing);
...
var CHAIN_CONFIGS = {
  mainnet: {
    GENESIS_FORK_VERSION: /*#__PURE__*/fromHexString('00000000'),
    GENESIS_VALIDATORS_ROOT: /*#__PURE__*/fromHexString('4b363db94e286120d76eb905340fdd4e54bfe9f06bf33ff6cf5ad27f511bfe95')
  },
  goerli: {
    GENESIS_FORK_VERSION: /*#__PURE__*/fromHexString('00001020'),
    GENESIS_VALIDATORS_ROOT: /*#__PURE__*/fromHexString('043db0d9a83813551ee2f33450d23797757d430911a9320530ad8a0eabc43efb')
  }
};
...
var parseAddressToBLS = function parseAddressToBLS(address) {
  return fromHexString("0x010000000000000000000000" + address.replace('0x', ''));
};
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          masterSecretKey = deriveKeyFromMnemonic(validatorMnemonic);
              ...
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    _context.next = 3;
                    return Keystore.create(password, secretKey.toBytes(), pubkey, "m/12381/3600/" + validatorIndex + "/0/0");
                  case 3:
...
export { DeriveValidator, GenerateKeystores, SignDepositData, index$2 as classes, index as constants, generateDepositData, generatePackedDepositData, index$3 as interfaces, index$1 as utils };
//# sourceMappingURL=eth2-beaconchain-utils.esm.js.map
